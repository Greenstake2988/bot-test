...
int main() {
	...
	bot.getEvents().onCommand("resumen", [&bot](TgBot::Message::Ptr message) {
		...
		if(not clientes_guardados[id_cliente_str]["orden"]["tma"].is_null()) bot.getApi().sendMessage(message->chat->id, std::to_string(clientes_guardados[id_cliente_str]["orden"]["tma"].get<int>()) + " Tacos de maiz de asado");
		if(not clientes_guardados[id_cliente_str]["orden"]["tmc"].is_null()) bot.getApi().sendMessage(message->chat->id, std::to_string(clientes_guardados[id_cliente_str]["orden"]["tmc"].get<int>()) + " Tacos de maiz con chicharra");
		if(not clientes_guardados[id_cliente_str]["orden"]["tme"].is_null()) bot.getApi().sendMessage(message->chat->id, std::to_string(clientes_guardados[id_cliente_str]["orden"]["tme"].get<int>())+ " Tacos de maiz especiales");
